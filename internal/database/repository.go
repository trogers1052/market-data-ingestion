...
// WARNING: This is expensive on large hypertables — takes ~1.8s per symbol
// due to query planning across all compressed chunks. Only use for CLI
// commands and quality checks, never in hot loops.
func (r *Repository) GetBarCountExact(ctx context.Context, symbol string) (int64, error) {
